-- Add comprehensive daily activities using only allowed activity types
...
-- Continue to day 10 (sampling key days)
...
('732eb308-3dc1-4dc3-adf9-472b91381db0', 1, 'morning', 'Grief Assessment & Compassionate Welcome', 'reflection',
 ...
 'beginner'),
('732eb308-3dc1-4dc3-adf9-472b91381db0', 1, 'evening', 'Creating Sacred Space for Healing', 'creative',
 'Create personal sacred space for grief work using creative expression.',
 'Design memory space, create art or writing tribute, set intentions for healing journey.',
 30, 'Creative arts therapy and continuing bonds research',
 ARRAY['Cultural sensitivity', 'Personal choice in expression'],
 'beginner'),
