  ...
  days: [
    {
      ...
      morning: [
        ...
        { id: '1-calming-breathing', time: '7:40 AM', activity: 'Calming Breath Practice', duration: '12 min', type: 'mindfulness', guideId: 'anxiety-calming-breathing' },
      ...
      afternoon: [
        ...
        { id: '1-anxiety-education', time: '1:00 PM', activity: 'Understanding Anxiety', duration: '20 min', type: 'therapy', guideId: 'anxiety-education' },
        { id: '1-grounding-54321', time: '1:30 PM', activity: '5-4-3-2-1 Grounding Technique', duration: '15 min', type: 'healing', guideId: 'grounding-54321' },
      ...
      evening: [
        ...
        { id: '1-worry-time', time: '7:30 PM', activity: 'Scheduled Worry Time', duration: '10 min', type: 'reflection', guideId: 'scheduled-worry' },
    ...
    },
    {
      ...
      morning: [
        ...
        { id: '2-vagus-movement', time: '8:30 AM', activity: 'Vagus Nerve Stimulating Movement', duration: '18 min', type: 'movement', guideId: 'vagus-nerve-movement' }
      ],
      afternoon: [
        { id: '2-mindful-lunch', time: '12:00 PM', activity: 'Mindful Lunch for Calm', duration: '25 min', type: 'nutrition' },
        { id: '2-cognitive-tools', time: '1:00 PM', activity: 'Cognitive Tools for Anxiety', duration: '25 min', type: 'therapy', guideId: 'anxiety-cognitive-tools' },
